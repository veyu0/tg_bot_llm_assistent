        ...
        async def ai_handler(message: Message):
            ...
            try:
                ...
                prompt = ChatPromptTemplate.from_messages([
                    ("system", "Ты полезный ассистент компании EORA, знающий о следующих проектах:\n{context}.Твоя задача отвечать на вопросы клиентов об этих проектах. Когда тебя задают вопрос, приводи примеры существующих проектов и сразу предоставляй ссылку на сайт с проектом.\nОтвечай на русском языке."),
                    ("user", "{input}")
                ])
